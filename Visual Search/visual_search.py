...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/pushkarsingh/Documents/01 University/02 Experimental Psychology/01 Lab/visual_search/visual_search.py',
...
if random < 1/2:
    ...
    thisExp.addData("number of distractors", number_of_distractors)
else:
    number_of_distractors = 5
    thisExp.addData("number of distractors", number_of_distractors)
    
for i in number_of_distractors:
...
distractor.setPos((random() - 0.5, random - 0.5))
# keep track of which components have finished
trialComponents = [Fixation, target, mouse, distractor]
