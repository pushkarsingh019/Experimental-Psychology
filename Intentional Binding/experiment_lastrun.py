...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/pushkarsingh/Documents/01 University/02 Experimental Psychology/01 Lab/Intentional Binding/experiment_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text="In the experiment you will see a green dot on the screen. When you see a green dot, press the spacebar. Following which you will hear a sound. \n\nThen you have to report what you think was the time in between you pressing the spacebar and you hearing the sound.\n\npress 'spacebar' to continue",
        font='Open Sans',
    ...
    cue = visual.ShapeStim(
        ...
        size=(0.2, 0.2), vertices='circle',
        ori=0.0, pos=(0, 0), anchor='center',
        lineWidth=1.0,     colorSpace='rgb',  lineColor=[-0.6078, 0.6078, -0.6078], fillColor=[-0.6078, 0.6078, -0.6078],
    ...
    # --- Initialize components for Routine "report_timing" ---
    ...
    slider = visual.Slider(win=win, name='slider',
        startValue=None, size=(1.0, 0.08), pos=(0, 0.0), units=win.units,
        labels=(0,250, 500, 750, 1000), ticks=(0,250,500,750,1000), granularity=0.0,
    ...
    for thisTrial in trials:
        ...
        _response_allKeys = []
        # keep track of which components have finished
        CueComponents = [fixation, cue, response]
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('beep.started', globalClock.getTime())
        sound_1.setSound(frequency, secs=0.3, hamming=True)
        ...
        for thisComponent in beepComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('beep.stopped', globalClock.getTime())
        ...
        # --- Prepare to start Routine "report_timing" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('report_timing.started', globalClock.getTime())
        slider.reset()
        # keep track of which components have finished
        report_timingComponents = [text, slider]
        for thisComponent in report_timingComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Ending Routine "report_timing" ---
        for thisComponent in report_timingComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('report_timing.stopped', globalClock.getTime())
        trials.addData('slider.response', slider.getRating())
        trials.addData('slider.rt', slider.getRT())
        # the Routine "report_timing" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
