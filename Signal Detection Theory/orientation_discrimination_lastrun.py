...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/pushkarsingh/Documents/01 University/02 Experimental Psychology/01 Lab/orientation_discrimination/orientation_discrimination_lastrun.py',
...
instruction = visual.TextStim(win=win, name='instruction',
    text="On the screen you will see a gaussian surface. The lines on the surface would either be tilted or striaght. \n\nPress the 'up' arrow key if the lines or straight or 'down' if the lines are tilted.\n\npress 'spacebar' to get started",
    font='Open Sans',
